...
Sito one-page cinematografico per **Arkadia Pub** (Ciampino, RM). Lo scroll è il
motore narrativo: mentre si scorre, un calice belga 3D **si riempie di birra
ambrata** fino al brindisi finale sulla call-to-action di prenotazione.

Costruito con **Astro** (statico, super veloce) + **Three.js** (il calice, geometria
procedurale e shader) + **Lenis** (smooth scroll). Nessun costo fisso: si pubblica
gratis su **Cloudflare Pages**.

- **Lighthouse mobile:** Performance 100 · Accessibilità 100 · Best Practices 100 · SEO 100
- **Bundle iniziale:** ~7,5 kB gzip (la scena 3D, ~123 kB gzip, si carica a parte solo se serve)
...
- **Birre alla spina** → array `birre.lista`: nome, stile, ABV, IBU, prezzo, nota.
- **Piatti** → array `cibo.piatti`: nome, prezzo, descrizione.
